...
document.getElementById('fsl').remove();
document.getElementsByClassName('FPdoLc VlcLAe')[0].remove()
document.getElementById('fbar').style = 'background:black;border-top: 1px solid black;';

var gb = document.getElementById('gb');
gb.style = 'position: relative;top: -155px;width: 100%;'
var searchfo = document.getElementById('searchform');
searchfo.style = 'position: relative;top: 180px;'
var hplogo = document.getElementById('hplogo');
hplogo.style = 'position:relative'
var lga = document.getElementById('lga');
lga.style = 'position:relative;height:233px;margin-top:0px'
...
secondrow.style = "position: relative;height:40vh;width:95vw"
body.appendChild(secondrow)
var container = document.createElement("div");
container.style = "position: relative;height:200px;width:600px"
...
container2.style = "position: relative;width:100vw;margain-top: 100px"
container2.id = 'container2'
let tab = document.createElement("table");
tab.id = 'highest_volume';
tab.class='display';
tab.style = "width: 100%;margin-top:230px"
...
let xhr2 = new XMLHttpRequest();
        ...
        const url2 = "https://api.iextrading.com/1.0/stock/market/list/infocus";
        
        xhr2.onreadystatechange = () => {
                if(xhr2.readyState === XMLHttpRequest.DONE){
                        let target = tab;
                        jsresp = JSON.parse(xhr2.response);
                        target.innerHTML = 'IN FOCUS<br/>';
